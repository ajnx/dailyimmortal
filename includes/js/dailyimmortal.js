...
const populateTable = function (timeFrame, char) {
    ...
    for (let taskSlug in data) {
        ...
        if (!!data[taskSlug].img) {
            newRowAnchor.innerHTML = "<img class='icon' src='../dailyimmortal/includes/img/activities/" + data[taskSlug].img + ".webp' alt=" + data[taskSlug].img + "/>" + data[taskSlug].task;
        } else {
        ...
        if (!!data[taskSlug].desc) {
			let dust = data[taskSlug].desc.replace("{dust}", "<img class='icon' src='../dailyimmortal/includes/img/activities/dust.webp' alt=Dust/><b style="+"color:#ff0;"+">Enchanted Dust</b>");
            let gems = dust.replace("{gems}", "<img class='icon' src='../dailyimmortal/includes/img/activities/gem.webp' alt=Gems/><b style="+"color:#2bd999;"+">Normal Gems</b>");
            let ember = gems.replace("{ember}", "<img class='icon' src='../dailyimmortal/includes/img/activities/ember.webp' alt=Ember/><b style="+"color:#5aabef;"+">Fading Ember</b>");
			let crest1 = ember.replace("{rare_crest}", "<img class='icon' src='../dailyimmortal/includes/img/activities/rare_crest.webp' alt=RareCrest/><b style="+"color:#ff0;"+">Rare Crest</b>");
			let crest2 = crest1.replace("{leg_crest}", "<img class='icon' src='../dailyimmortal/includes/img/activities/leg_crest.webp' alt=LegendaryCrest/><b style="+"color:#bf642f;"+">Legendary Crest</b>");
